...
SANOOK_DISABLE_AUTO_MAINTAIN=1      # skip background memory/vault consolidation and auto-distill
SANOOK_AUTO_DISTILL=1               # force session distill even when autoMaintain config is off
