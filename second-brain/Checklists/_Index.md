...
> preflight/postflight gate (ticklist)

## ใส่ที่นี่
ticklist ก่อน-หลังลงมือ ต่อ task-family
...
- เมื่อสร้างโน้ตในโฟลเดอร์นี้: ตั้ง `parent: "[[Checklists/_Index]]"` และท้ายไฟล์ `up:: [[Checklists/_Index]]`
